 ...
 *
 * Project: sintec
 *    File: SubDepartamento.js
 *
 * - Departamento
 *
 * @class
 * @classdesc Objeto de mapeo para los el filtro de sub departamento.
 * @summary   Contiene un identificador y una descripcion.
