 ...
 */
@Entity
@Table(name = "tbl_full_Margen", schema = "dbo", catalog = "Herramientas")
public class TblFullMargenEntity {
    private int id;
    ...
    /**
     * Getter for fullMargen.
     * @return fullMargen.
     **/
    @Basic
    @Column(name = "full_margen", nullable = true, precision = 0)
    public Double getFullMargen() {
        return fullMargen;
    }

    /**
     * Setter for fullMargen.
     * @param fullMargen expected.
     **/
    public void setFullMargen(Double fullMargen) {
        this.fullMargen = fullMargen;
    }
    ...
    public boolean equals(Object o) {
        ...
        TblFullMargenEntity that = (TblFullMargenEntity) o;
        ...
        if (precioUnitario != null ? !precioUnitario.equals(that.precioUnitario) : that.precioUnitario != null)
            return false;
        if (fullMargen != null ? !fullMargen.equals(that.fullMargen) : that.fullMargen != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (fullMargen != null ? fullMargen.hashCode() : 0);
